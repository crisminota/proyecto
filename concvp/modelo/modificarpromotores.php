...
<html lang="es">
    <head>
       ...
       <link rel="stylesheet" type="text/css" href="http://fonts.googleapis.com/css?family=Tangerine">
        ...
        <title>modifcar promotores</title>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-6 col-sm-6 col-md-5 col-lg-7 col-md-offset-2">
                    <form name="form" action="modificarpromotores2.php" method="post">
            ...
            <table class="table table-striped table-bordered table-hover">
                ...
                <tr>
                    ...
                    <tr>
                        ...
                        <td class="relleno blanco" ><input type="text" name="NOMBRE_PROMOTOR" value="<?php echo $reg["NOMBRE_PROMOTOR"]; ?>">   
                    <tr>
                        <td class="relleno silver">id zona
                        <td class="relleno blanco"><input type="text" name="ID_ZONA" value="<?php echo $reg["ID_ZONA"]; ?>">  
                             <tr>
                        <td class="relleno silver">direccion
                        <td class="relleno blanco"><input type="text" name="DIRECCION" value="<?php echo $reg["DIRECCION"]; ?>">  
            </tbody>
